...
var _bling = __webpack_require__(/*! ./modules/bling */ "./public/javascripts/modules/bling.js");

var _autocomplete = __webpack_require__(/*! ./modules/autocomplete */ "./public/javascripts/modules/autocomplete.js");

var _autocomplete2 = _interopRequireDefault(_autocomplete);

var _typeAhead = __webpack_require__(/*! ./modules/typeAhead */ "./public/javascripts/modules/typeAhead.js");

var _typeAhead2 = _interopRequireDefault(_typeAhead);

var _map = __webpack_require__(/*! ./modules/map */ "./public/javascripts/modules/map.js");
...
function autocomplete(input, latInput, lngInput) {
  ...
  input.on('keydown', function (e) {
    return e.code === 'Enter' ? e.preventDefault() : false;
  });
}
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      return res.data.length ? searchResults.innerHTML = (0, _dompurify.sanitize)(searchResultsHTML(res.data)) : searchResults.innerHTML = (0, _dompurify.sanitize)('\n                <div className="search__result">\n                  No Results for ' + _this.value + ' were found!\n                </div>\n              ');
    })
  ...
  searchInput.on('keyup', function (_ref2) {
